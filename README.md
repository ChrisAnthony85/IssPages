...
This application displays 0 to 10 places of interest near the current location of the
ISS.
...
You can then execute your native executable with: `./target/isspages-1.0-SNAPSHOT-runner`
